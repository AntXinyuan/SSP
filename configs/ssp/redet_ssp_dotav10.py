...
model = dict(
    ...
    backbone=dict(
        ...
        frozen_stages=1,
        style='pytorch',
        pretrained='pretrained/re_resnet50_c8_batch256-25b16846.pth'),
    neck=dict(
        type='ReFPN',
...
# this config is for 4 gpus, where total_bs=2*4=8, total_lr=0.005*4=0.02, total_iter_per_batch=1600